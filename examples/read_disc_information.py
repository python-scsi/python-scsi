...
def main():
    ...
    with SCSI(device) as s:
        ...
        try:
            ...
            if i['disc_information_data_type'] == cmd.DISC_INFORMATION_DATA_TYPE.STANDARD_DISC_INFORMATION:
                pi(i, 'ERASABLE')
                ...
                print('LAST_SESSION_LEAD_IN_START_ADDRESS', i['last_session_lead_in_start_address'])
                print('LAST_POSSIBLE_LEAD_OUT_START_ADDRESS', i['last_possible_lead_out_start_address'])
